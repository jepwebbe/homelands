...
export const StyledGrid = styled.main`
  ...
  >:first-child {
    ...
    @media (min-width: ${(props) => props.theme.breakpoints.l}) {
      grid-template-columns: ${(props) => props.theme.desktopThree.columns};
      grid-template-rows: ${(props) => props.theme.desktopThree.rows};
      grid-template-areas: ${(props) => props.theme.desktopThree.area};
    }
  }
`;